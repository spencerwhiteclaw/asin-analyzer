// ═══════════════════════════════════════════════════════════════
// ASIN Analyzer v4.7 — Server (Sprint 0: Modularized)
...
app.use('/api/admin',  adminRoutes);      // /api/admin/health (Sprint 7B fills the rest)

// ═══ PAGE ROUTES — Social meta tags for reports ═══
