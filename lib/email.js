      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;">
            ...
            <a href="https://www.asinanalyzer.app/report/${report.id}" style="display:inline-block;padding:14px 32px;background:#3B82F6;color:#fff;text-decoration:none;border-radius:10px;font-weight:700;margin:16px 0;">View Full Report &rarr;</a>
            <hr style="border:none;border-top:1px solid #E2E8F0;margin:24px 0;" />
            <p style="font-size:13px;color:#94A3B8;">&copy; 2026 ASIN Analyzer &middot; <a href="https://www.asinanalyzer.app" style="color:#3B82F6;">asinanalyzer.app</a></p>
          </div>
        `,
      }),
    });
